public class PaymentTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Memproses pembayaran sebesar " + (int)eWallet.nominalTransaksi + "...");
        
        eWallet.processPayment();
        System.out.println("Sisa saldo: " + (int)eWallet.getBalance());
        System.out.println("Detail Transaksi: Pembayaran dilakukan melalui " + eWallet.namaLayanan);
